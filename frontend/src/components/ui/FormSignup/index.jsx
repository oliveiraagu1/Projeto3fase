...
export function FormSignup() {
    ...
    return (
        <form onSubmit={handleSubmit(handleSignup)} className={styles.form}>
            ...
            <input
                {...register("name")}
                className={errors.name?.type === 'required' || errors.name?.type === 'min'  ? styles.inputError : styles.input}
                type="text"
            ...
            <input
                {...register("password")}
                className={errors.password?.type === 'required' || errors.password?.type === 'min'  ? styles.inputError : styles.input}
                type="password"
            ...
            <input
                ...
                className={errors.registration?.type === 'typeError' || errors.registration?.type === 'min'  ? styles.inputError : styles.input}
                type="number"
